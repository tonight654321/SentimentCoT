...
if __name__ == "__main__":
    ...
    parser.add_argument('--r_file', type=str, default='../data/Restaurants_Test_Train_Gold_Implicit_Labeled.xml', help='Path to the input XML file')
    ...
    if args.aspects_reverse:
        output_file_json = os.path.join(result_dir,
                                        f"results_reverse_{prompt_name}_{args.num_of_shots}-shot_{model_name}_{timestamp}.jsonl")
    else:
